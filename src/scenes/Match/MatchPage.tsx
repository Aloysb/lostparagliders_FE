    ...
    <CenterContainer logo={false}>
      ...
      {!isMatching ? (
        ...
        <div className='flex flex-col justify-around items-center'>
          ...
          <div className='w-2/3 mt-8 mb-4 mx-auto flex-grow text-white border-white border-2 border-solid rounded px-8 py-4 pb-8 divide-y'>
            ...
            <div>
              ...
              <p className='py-3'>
                We won’t use your contact details and you can remain anonymous
                if you wish. The person that has registered this gear as stolen
                will be alerted and you will receive his/her contact details
                through email.
              </p>
              <p className='py-3'>
                ...
                this equipment tagged as stolen or not.
              </p>
              <p>Together, let’s fight against thieves !</p>
            </div>
          </div>
          <div className=' self-center flex justify-around'>
